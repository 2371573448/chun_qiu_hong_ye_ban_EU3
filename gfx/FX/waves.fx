...
VS_OUTPUT VertexShader_Waves(const VS_INPUT v )
{
...
float4 PixelShader_Waves( VS_OUTPUT v ) : COLOR
{
...
float4 PixelShader_Waves_Color( VS_OUTPUT v ) : COLOR
{
...
technique WavesShader
{
	pass p0
	{
		...
		VertexShader = compile vs_1_1 VertexShader_Waves();
		PixelShader = compile ps_2_0 PixelShader_Waves();
	}
}

technique WavesShaderColor
{
	pass p0
	{
		ALPHABLENDENABLE = True;
		...
		VertexShader = compile vs_1_1 VertexShader_Waves();
		PixelShader = compile ps_2_0 PixelShader_Waves_Color();
	}
}